...
function Form(handleSubmit){
    ...
    return(
        ...
        >
            <input type="text" placeholder="search..." name="search" onChange={updateSearchInput} value={searchEntry} />

            <button type="submit" disabled={!searchEntry.trim()} className={`search-button ${searchEntry.trim() ? "active" : "" }`}>
